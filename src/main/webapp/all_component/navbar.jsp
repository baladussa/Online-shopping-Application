...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-4 text-success">
			<h3>
				<i class="fa-solid fa-bag-shopping"></i> P-KART Online Shopping 
			</h3>
		</div>
		<div class="col-md-4">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="all_recent_book.jsp"><i class="fa-solid fa-basket-shopping text-warning"></i>
					All Items</a></li>
			<li class="nav-item active"><a class="nav-link"
				href="all_new_book.jsp"><i class="fa-solid fa-laptop-medical text-primary"></i>
					All New Items</a></li>
			<li class="nav-item active"><a class="nav-link disabled"
				href="all_old_book.jsp"><i class="fa-solid fa-shirt text-success"></i>
					Fashion</a></li>
		</ul>
